...
static TYPE_DEF_TEMPLATE_BOOL sg_button_report_button_state   = 0;
static DeviceProperty         g_propertyEvent_button_report[] = {

    {.key = "button_state", .data = &sg_button_report_button_state, .type = TYPE_TEMPLATE_BOOL},
};
...
static sEvent g_events[] = {
    ...
    {
        .event_name   = "button_report",
        .type         = "info",
        .timestamp    = 0,
        .eventDataNum = sizeof(g_propertyEvent_button_report) / sizeof(g_propertyEvent_button_report[0]),
        .pEventData   = g_propertyEvent_button_report,
    },
};
