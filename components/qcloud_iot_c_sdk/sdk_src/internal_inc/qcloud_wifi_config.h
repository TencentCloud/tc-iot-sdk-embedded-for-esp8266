...
extern "C" {
#endif
// eps Automatically generated file
#include "sdkconfig.h"
...
#else
#define WIFI_PROV_SOFT_AP_ENABLE 0
#endif

#ifdef CONFIG_SMART_CONFIG_ENABLED
#define WIFI_PROV_SMART_CONFIG_ENABLE 1  ///< wifi provisioning method: smart config, need Wechat Applets
#else
#define WIFI_PROV_SMART_CONFIG_ENABLE 0
#endif
#ifdef CONFIG_AIRKISS_CONFIG_ENABLED
#define WIFI_PROV_AIRKISS_CONFIG_ENABLE 1
#else
