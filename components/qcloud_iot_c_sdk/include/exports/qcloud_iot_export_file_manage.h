...
#define FILE_MANAGE_INFO_LEN_MAX                                                                   \
    (FILE_MANAGE_VERSION_STR_LEN_MAX + FILE_MANAGE_NAME_STR_LEN_MAX + FILE_MANAGE_INFO_FIXED_LEN + \
     FILE_MANAGE_TYPE_STR_LEN_MAX)
 ...
 */
int IOT_FileManage_Post_Request(void *handle, uint32_t timeout_ms, const char *res_name, char *res_version,
                                char *res_type);
